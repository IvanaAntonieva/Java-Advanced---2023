...
public class Ex_10_Robotics {
    public static void main(String[] args) {
        ...
        while (!products.isEmpty()) {
            ...
            startTimeInSeconds++;
            decreasedWorkingTime(robotsWorkingTime);
    ...
    private static void decreasedWorkingTime(LinkedHashMap<String, Integer> robotsWorkingTime) {
        for(Map.Entry<String, Integer> robot : robotsWorkingTime.entrySet()){
        if (robot.getValue() > 0) {
    ...
    private static Integer getStartTimeInSeconds(String startTime) {
